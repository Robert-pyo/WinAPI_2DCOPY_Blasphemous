...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   rc.right = WINSIZE_X;
   rc.bottom = WINSIZE_Y;
   // 실제 내용 창이 크기에 맞게끔 하도록 사이즈 조정이 필요함
   AdjustWindowRect(&rc, WINSTYLE, false);      // rc의 left, top, right, bottom 값을 원하는 해상도의 값으로 바꿔줌
   // 위에서 얻은 사이즈로 윈도우 사이즈를 세팅
   SetWindowPos(hWnd, NULL, WINSTART_X, WINSTART_Y, (rc.right - rc.left), (rc.bottom - rc.top), SWP_NOZORDER | SWP_NOMOVE);
